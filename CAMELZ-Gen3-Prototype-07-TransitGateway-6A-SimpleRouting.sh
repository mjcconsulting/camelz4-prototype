...
global_core_tgw_default_rtb_id=$(aws ec2 create-transit-gateway-route-table --transit-gateway-id $global_core_tgw_id \
                                                                            --tag-specifications "ResourceType=transit-gateway-route-table,Tags=[{Key=Name,Value=Core-TransitGatewayDefaultRouteTable},{Key=Company,Value=DXC},{Key=Environment,Value=Core},{Key=Project,Value=\"CAMELZ3 POC\"},{Key=Note,Value=\"Associated with the CAMELZ3 POC - do not alter or delete\"}]" \
