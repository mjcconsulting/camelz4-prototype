...
#######################################################################################################################
## Directory Service SSM Associations - PerClient Model ###############################################################
#######################################################################################################################
...
## Create Alfa Ohio Core Default JoinDirectoryServiceDomain SSM Association ###########################################
...
#                             --parameters directoryId=$alfa_ohio_production_directory_id,directoryName=$alfa_ohio_production_directory_domain,dnsIpAddresses="[$dc_ip1,$dc_ip2]" \
