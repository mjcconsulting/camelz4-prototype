# Modules:Public Hosted Zones:Core Account:Oregon:Core Hosted Zone

This module creates the Core Public Hosted Zone in the AWS Oregon (us-west-2) Region within the
CaMeLz-Core Account.
