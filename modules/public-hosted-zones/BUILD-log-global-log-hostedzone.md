# Modules:Public Hosted Zones:Log Account:Global:Log Hosted Zone

This module creates the Log Public Hosted Zone in the AWS Virginia (us-east-1) Region within the
CaMeLz-Log Account.
