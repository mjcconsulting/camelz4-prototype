# Modules:Public Hosted Zones:Management Account:Ohio:Management Hosted Zone
...
1. **Create Check TXT Record in Public Hosted Zone and Confirm**
   ...
   properly setup in the public DNS hierarchy.
    ...
    sed -e "s/@txtname@/check.$ohio_management_public_domain/g" \
    ...
    [ $(dig +short -t TXT check.$ohio_management_public_domain) = "\"$txtvalue\"" ] && echo "Check confirmed"
    ```
