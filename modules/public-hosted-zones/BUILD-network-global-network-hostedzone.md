...
1. **Configure Sub-Domain Name Servers in the Parent Hosted Zone**
    ...
    sed -e "s/@name@/$global_network_public_domain/g" \
...
1. **Create Check TXT Record in Public Hosted Zone and Confirm**
   ...
   properly setup in the public DNS hierarchy.
    ...
    sed -e "s/@name@/check.$global_network_public_domain/g" \
        -e "s/@value@/$value/g" \
    ...
    [ "$(dig +short -t TXT check.$global_network_public_domain)" = "\"$value\"" ] && echo "Check confirmed" || echo "Check failed"
    ```
