# Modules:Roles:Recovery:Global

This module builds IAM Roles in the AWS Virginia (us-east-1) Region within the CaMeLz-Recovery & Alfa-CaMeLz-Recovery
Accounts.
